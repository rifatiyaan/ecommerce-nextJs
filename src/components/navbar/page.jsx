        ...
        <div className="z-[100] fixed top-0 left-0 w-full bg-white text-black shadow-md px-2">
          <div className="container mx-auto flex justify-between items-center px-4 py-2">
            ...
            <div className="hidden md:flex items-center relative">
              ...
              <Link href="/allProducts" className="flex items-center font-thin text-sm px-3 py-2 rounded text-black hover:text-blue-500">
              All Products
              </Link>
              <Link href="/productDetails" className="flex items-center font-thin text-sm px-3 py-2 rounded text-black hover:text-blue-500">
                Product Details
              </Link>
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <Link href="/allProducts" className="px-3  py-2 rounded font-thin text-sm text-black hover:text-blue-500">
                All Products
              </Link>
              <Link href="/productDetails" className="px-3 py-2 rounded font-thin text-sm text-black hover:text-blue-500">
              Product Details
              </Link>
            </div>
          </div>
